...
export const BANKING_INSTITUTIONS: Record<string, CountryBankingConfig> = {
  ...
  // ─────────────────────────────────────────────────────────────
  // Nigeria (NG) — CBN-licensed banks, MFBs, PSBs & mobile money
  // ─────────────────────────────────────────────────────────────
  NG: {
    countryCode: 'NG',
    countryName: 'Nigeria',
    ...
    clearingHouses: [
      { code: 'NIBSS_NIP',   name: 'NIBSS Instant Payment (NIP)', type: 'rtgs',   description: 'Instant transfers to any Nigerian bank via NIBSS' },
      { code: 'NIBSS_NEFT',  name: 'NIBSS Electronic Funds Transfer (NEFT)', type: 'ach', description: 'Standard batch bank-to-bank transfer' },
      { code: 'CBN_RTGS',    name: 'CBN RTGS', type: 'rtgs',                    description: 'High-value real-time gross settlement' },
      { code: 'MTN_MOMO_NG', name: 'MTN MoMo PSB',              type: 'mobile', description: 'MTN payment service bank wallet' },
      { code: 'SMARTCASH',   name: 'Airtel SmartCash PSB',      type: 'mobile', description: 'Airtel payment service bank wallet' },
      { code: '9PSB',        name: '9mobile 9PSB',              type: 'mobile', description: '9mobile payment service bank wallet' },
      { code: 'OPAY_WALLET', name: 'OPay Wallet',               type: 'mobile', description: 'OPay mobile wallet' },
      { code: 'PALMPAY_WALLET', name: 'PalmPay Wallet',         type: 'mobile', description: 'PalmPay mobile wallet' },
      { code: 'PAGA',        name: 'Paga',                      type: 'mobile', description: 'Paga mobile money' },
      { code: 'EFINMONEY',   name: 'eFinMoney',                 type: 'mobile', description: 'eFinsuite mobile money wallet' },
    ],
    institutions: [
      // Commercial banks (CBN sort codes)
      { code: '044', name: 'Access Bank',                       swiftCode: 'ABNGNGLA', type: 'commercial' },
      { code: '063', name: 'Access Bank (Diamond)',             swiftCode: 'DBLNNGLA', type: 'commercial' },
      { code: '023', name: 'Citibank Nigeria',                  swiftCode: 'CITINGLX', type: 'commercial' },
      { code: '050', name: 'Ecobank Nigeria',                   swiftCode: 'ECOCNGLA', type: 'commercial' },
      { code: '070', name: 'Fidelity Bank',                     swiftCode: 'FIDTNGLA', type: 'commercial' },
      { code: '011', name: 'First Bank of Nigeria',             swiftCode: 'FBNINGLA', type: 'commercial' },
      { code: '214', name: 'First City Monument Bank (FCMB)',   swiftCode: 'FCMBNGLA', type: 'commercial' },
      { code: '058', name: 'Guaranty Trust Bank (GTBank)',      swiftCode: 'GTBINGLA', type: 'commercial' },
      { code: '030', name: 'Heritage Bank',                     swiftCode: 'HBCLNGLA', type: 'commercial' },
      { code: '301', name: 'Jaiz Bank (Non-Interest)',          swiftCode: 'JAIZNGLA', type: 'commercial' },
      { code: '082', name: 'Keystone Bank',                     swiftCode: 'PLNINGLA', type: 'commercial' },
      { code: '303', name: 'Lotus Bank (Non-Interest)',                                type: 'commercial' },
      { code: '076', name: 'Polaris Bank',                      swiftCode: 'PRDTNGLA', type: 'commercial' },
      { code: '101', name: 'Providus Bank',                                            type: 'commercial' },
      { code: '221', name: 'Stanbic IBTC Bank',                 swiftCode: 'SBICNGLX', type: 'commercial' },
      { code: '068', name: 'Standard Chartered Bank Nigeria',   swiftCode: 'SCBLNGLA', type: 'commercial' },
      { code: '232', name: 'Sterling Bank',                     swiftCode: 'NAMENGLA', type: 'commercial' },
      { code: '100', name: 'SunTrust Bank',                                            type: 'commercial' },
      { code: '302', name: 'TAJ Bank (Non-Interest)',                                  type: 'commercial' },
      { code: '102', name: 'Titan Trust Bank',                                         type: 'commercial' },
      { code: '032', name: 'Union Bank of Nigeria',             swiftCode: 'UBNINGLA', type: 'commercial' },
      { code: '033', name: 'United Bank for Africa (UBA)',      swiftCode: 'UNAFNGLA', type: 'commercial' },
      { code: '215', name: 'Unity Bank',                        swiftCode: 'ICITNGLA', type: 'commercial' },
      { code: '035', name: 'Wema Bank',                         swiftCode: 'WEMANGLA', type: 'commercial' },
      { code: '057', name: 'Zenith Bank',                       swiftCode: 'ZEIBNGLA', type: 'commercial' },
      { code: '103', name: 'Globus Bank',                                              type: 'commercial' },
      { code: '104', name: 'Parallex Bank',                                            type: 'commercial' },
      { code: '105', name: 'Premium Trust Bank',                                       type: 'commercial' },
      { code: '106', name: 'Signature Bank',                                           type: 'commercial' },
      { code: '559', name: 'Coronation Merchant Bank',                                 type: 'commercial' },
      { code: '502', name: 'Rand Merchant Bank Nigeria',                               type: 'commercial' },
      { code: '507', name: 'FBNQuest Merchant Bank',                                   type: 'commercial' },
      { code: '501', name: 'FSDH Merchant Bank',                                       type: 'commercial' },
      { code: '562', name: 'Greenwich Merchant Bank',                                  type: 'commercial' },
      { code: '561', name: 'Nova Merchant Bank',                                       type: 'commercial' },

      // Microfinance & neo-banks
      { code: '50211', name: 'Kuda Microfinance Bank',          type: 'microfinance' },
      { code: '50515', name: 'Moniepoint Microfinance Bank',    type: 'microfinance' },
      { code: '999992', name: 'OPay Digital Services',          type: 'microfinance' },
      { code: '999991', name: 'PalmPay',                        type: 'microfinance' },
      { code: '51310', name: 'Sparkle Microfinance Bank',       type: 'microfinance' },
      { code: '125',    name: 'Rubies Microfinance Bank',       type: 'microfinance' },
      { code: '566',    name: 'VFD Microfinance Bank',          type: 'microfinance' },
      { code: '50304',  name: 'Mint Microfinance Bank',         type: 'microfinance' },
      { code: '51318',  name: 'FairMoney Microfinance Bank',    type: 'microfinance' },

      // Mobile money / wallet aliases (so they appear in wallet lookups too)
      { code: 'EFINMONEY_W', name: 'eFinMoney',                 type: 'mobile_money' },
      { code: 'MTN_MOMO_W',  name: 'MTN MoMo PSB',              type: 'mobile_money' },
      { code: 'SMARTCASH_W', name: 'Airtel SmartCash PSB',      type: 'mobile_money' },
      { code: '9PSB_W',      name: '9mobile 9PSB',              type: 'mobile_money' },
      { code: 'OPAY_W',      name: 'OPay Wallet',               type: 'mobile_money' },
      { code: 'PALMPAY_W',   name: 'PalmPay Wallet',            type: 'mobile_money' },
      { code: 'PAGA_W',      name: 'Paga',                      type: 'mobile_money' },
    ],
    creditCardIssuers: [
      { code: 'GTB_MC',     name: 'GTBank Mastercard',        network: 'mastercard', type: 'bank' },
      { code: 'ZENITH_MC',  name: 'Zenith Bank Mastercard',   network: 'mastercard', type: 'bank' },
      { code: 'ACCESS_VISA',name: 'Access Bank Visa',         network: 'visa',       type: 'bank' },
      { code: 'UBA_VISA',   name: 'UBA Visa',                 network: 'visa',       type: 'bank' },
      { code: 'FBN_VISA',   name: 'First Bank Visa',          network: 'visa',       type: 'bank' },
      { code: 'VERVE',      name: 'Verve (Interswitch)',      network: 'other',      type: 'independent' },
    ],
    accountNumberFormat: {
    ...
    complianceLabels: {
      encryption: 'AES-256 encryption • CBN-compliant',
      regulation: 'Regulated by CBN • NDPR/NDPA compliant',
    },
  },
};
