...
const reports: ReportItem[] = [
  ...
  { id: 'customer-statement', name: 'Customer Statement', description: 'Individual customer account statements', category: 'Sales', module: 'Sales', icon: <FileCheck className="w-5 h-5" />, href: '/sales/customers' },
