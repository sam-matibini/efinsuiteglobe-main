...
export default function BalanceSheet() {
  ...
  // Get comparative totals for display. Recompute each period's totalEquity to
  // match the on-screen equity rows: non-RE/CYE/dividend equity accounts +
  // Statement of Retained Earnings closing balance. This mirrors the current
  // period logic and prevents dividends/drawings from being double-counted
  // (they're already netted inside the RE closing balance).
  ...
  const comparativeTotals = useMemo(() => {
    ...
    return rawComparativeTotals.map((ct: any, i: number) => {
      ...
      // Per-period equity balances from the comparative dataset
      ...
      if (pd?.balances) {
        ...
        // i === 0 is the current period; comparatives are 1..N
        const reClosing = i === 0
