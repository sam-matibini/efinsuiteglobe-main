...
const NG: CountryPayrollPdfConfig = {
  slip: {
    formTitle: 'Annual Tax Deduction Certificate',
    formCode: 'PAYE Certificate',
    taxIdLabel: 'Employer TIN',
    authorityLine: 'Nigeria Revenue Service (NRS)',
    ...
    fields: [
      ...
      { code: '4', label: 'NHF / Other statutory', source: 'socialInsurance' },
      { code: '5', label: 'Pensionable earnings', source: 'pensionableEarnings' },
    ],
  },
  remittance: {
    formTitle: 'Monthly PAYE & Statutory Remittance',
    formCode: 'PAYE-Sched',
    authorityName: 'State Internal Revenue / NRS',
    taxIdLabel: 'Employer TIN',
    rows: [
      ...
      { label: 'NHF — employee (2.5%)', source: 'socialInsuranceEmployee' },
      { label: 'NHF — employer', source: 'socialInsuranceEmployer' },
    ],
    detailColumns: [
      { label: 'Employee', source: 'name' },
      { label: 'Gross', source: 'gross' },
  ...
  separation: {
    docTitle: 'Termination / Disengagement Letter',
    docCode: 'TERM',
