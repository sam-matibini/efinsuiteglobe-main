...
BEGIN
  ...
  -- Direct adjustments to RE account within the period (folded into Opening)
  ...
  -- Fold direct RE postings into the Opening Balance instead of surfacing as
  -- "Other additions / Other deductions". CLOSE-* system closes are still excluded.
