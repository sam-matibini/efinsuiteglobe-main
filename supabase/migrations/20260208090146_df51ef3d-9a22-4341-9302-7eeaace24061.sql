-- Fix Statement of Retained Earnings: opening balance must use the correct fiscal year
-- For non-calendar fiscal years, the fiscal year number is derived from the period end date
