-- Fix get_retained_earnings_rollforward_series to properly include direct RE postings
-- and align with calculate_opening_retained_earnings logic
...
BEGIN
  ...
  FOR v_loop_year IN v_first_year..v_last_year LOOP
    ...
    -- This function correctly handles direct RE postings and year-over-year continuity
