...
-- Fix Net Income / Opening RE to use base_currency amounts (multi-currency correctness)
...
-- Also recalculate cached current_balance for all Oluspe Auto accounts
SELECT public.recalculate_all_account_balances('1f8d9dc0-b4c1-4b40-b67d-b1d396d74b83'::uuid);
