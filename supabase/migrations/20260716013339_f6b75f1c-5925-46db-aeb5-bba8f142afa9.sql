...
BEGIN
  ...
  -- Base opening = closing RE from prior fiscal year (rollforward)
  ...
  -- Direct RE postings in this period (excluding system closes): fold into
  -- Opening Retained Earnings as prior-period equity carryforward. This
  -- preserves ASPE rollforward and avoids synthetic non-CoA "Other" lines.
